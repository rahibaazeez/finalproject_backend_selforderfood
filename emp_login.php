...
if(isset($_POST['submit'])){
  ...
  if($email=="employee@gmail.com" && $password=="456"){
    // $value=$_SESSION['']
    echo'<script>alert("Succesfully login ");window.location.href="emp_home.php"</script>';
  }else{
    echo'<script>alert("you are not a admin or employee");window.location.href="#"</script>';
  }
}
?>
