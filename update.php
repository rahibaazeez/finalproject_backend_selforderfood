...
if(isset($_POST['submit'])){
  ...
  $price=$_POST['price'];
    ...
    $sql1 = mysqli_query($conn, "UPDATE food_details SET photo='$image', food_name='$foodname', ingredients='$ingredients', preparationtime='$preparationtime', price='$price' WHERE food_id='$id'");
    if($sql1)
    {
        echo '<script> alert("updated sucessfully");window.location.href="food_view.php";</script>';
    }
    else{
                ...
                <center>
                    <form method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                          ...
                          <input type="text" name="foodname" class="form-control" value="<?php echo $row['food_name'];?>" >
                          
                        </div>
                        <div class="mb-3">
                          <label for="" class="form-label">Ingredients</label>
                          <input type="text" name="ingredients" class="form-control" value="<?php echo $row['ingredients'];?>" >
                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label">Preparation Time</label>
                            <input type="time" name="preparationtime" class="form-control"value="<?php echo $row['preparationtime'];?>" >
                          </div>
                          <div class="mb-3">
